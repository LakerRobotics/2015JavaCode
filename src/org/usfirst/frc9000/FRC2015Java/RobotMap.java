...
import edu.wpi.first.wpilibj.CounterBase.EncodingType; import edu.wpi.first.wpilibj.PIDSourceType;
...
public class RobotMap {
    ...
    public static void init() {
        ...
        driveRightWheelsEncoder.setPIDSourceType(PIDSourceType.kRate);
        ...
        driveLeftWheelsEncoder.setPIDSourceType(PIDSourceType.kRate);
        ...
        clawClawEncoder.setPIDSourceType(PIDSourceType.kRate);
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        driveGyro.setPIDSourceType(PIDSourceType.kRate);
