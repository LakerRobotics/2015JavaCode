...
public class OI {
    ...
    public OI() {
        ...
        clawOpenButton = new JoystickButton(joystickOperator, 1);
        ...
        SmartDashboard.putData("ClawSqueeze", new ClawSqueeze());

        SmartDashboard.putData("DriveForward", new DriveForward());

        SmartDashboard.putData("Turn90Degrees", new Turn90Degrees());

        SmartDashboard.putData("DriveSquareTest", new DriveSquareTest());

        SmartDashboard.putData("Turn360", new Turn360());

        SmartDashboard.putData("ElevatorToHeight", new ElevatorToHeight());

        SmartDashboard.putData("GyroTest", new GyroTest());

        SmartDashboard.putData("Turn", new Turn());

        SmartDashboard.putData("DriveOutAndBack", new DriveOutAndBack());

        SmartDashboard.putData("TestDriveCommands", new TestDriveCommands());

        SmartDashboard.putData("Figure8", new Figure8());

        SmartDashboard.putData("Drive10Feet", new Drive10Feet());
