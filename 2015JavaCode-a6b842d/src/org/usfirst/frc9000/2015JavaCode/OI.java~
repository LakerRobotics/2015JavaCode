...
import org.usfirst.frc9000.2015JavaCode.commands.*;
...
public class OI {
    ...
    public JoystickButton clawSqueezeButton;
    ...
    public OI() {
        ...
        clawSqueezeButton = new JoystickButton(joystickOperator, 1);
        clawSqueezeButton.whileHeld(new ClawSqueeze());
